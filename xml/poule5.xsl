		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="simpleA4">
				<fo:flow flow-name="xsl-region-body" >	
					...
					<fo:block font-size="10pt" space-after="0.5cm" space-before="1cm" text-align="left" >Poule de 5 : 1x2 - 3x4 - 1x5 - 2x3 - 4x5 - 1x3 - 2x5 - 1x4 - 3x5 - 2x4</fo:block>
						...
						<fo:table table-layout="fixed" width="100%">
							...
							<fo:table-body >
								<fo:table-row height="15px">
									...
									<fo:table-cell padding="1px" border="1px solid black"><fo:block text-align="center" font-weight="bold">5</fo:block></fo:table-cell>
								...
								<fo:table-row height="15px">
									<fo:table-cell padding="3px" number-rows-spanned="2" display-align="center" text-align="left" border-left="1px solid black" border-right="1px solid black" border-top="1px solid black"><fo:block font-weight="bold"><xsl:value-of select="$combattant5"/></fo:block></fo:table-cell>
									<fo:table-cell padding="1px" border="1px solid black" number-rows-spanned="3" display-align="center" text-align="center"><fo:block font-weight="bold">1</fo:block></fo:table-cell>
									<fo:table-cell padding="1px" border="1px solid black" number-rows-spanned="3"><fo:block></fo:block></fo:table-cell>
									<fo:table-cell padding="1px" border="1px solid black" number-rows-spanned="3"><fo:block></fo:block></fo:table-cell>
									<fo:table-cell padding="1px" border="1px solid black" number-rows-spanned="3"><fo:block></fo:block></fo:table-cell>
								...
								<fo:table-row height="15px">
									<fo:table-cell padding="3px" border-left="1px solid black" border-right="1px solid black" border-bottom="1px solid black"><fo:block display-align="center" font-size="8pt"><xsl:value-of select="$club5"/></fo:block></fo:table-cell>									
									<fo:table-cell padding="1px" border="1px solid black" display-align="center"><fo:block font-size="8pt">Points</fo:block></fo:table-cell>
									<fo:table-cell padding="1px" border="1px solid black"><fo:block></fo:block></fo:table-cell>									
								</fo:table-row>
							</fo:table-body>
